    ...
    <Container maxWidth="xl">
      ...
      >
        <div className="content" style={{ textAlign: 'center' }}>
          ...
          <Button onClick={handleGetQuoteClick} variant="outlined" size="large" style={{ marginTop: 10, color: 'white', backgroundColor: "blue", borderRadius: '10px', fontSize: '20px'}}>
            GET YOUR FREE QUOTE
          </Button>
        </div>
      </div>
      ...
      <div style={{ padding: '20px', textAlign: 'center', marginTop: '50px' }}>
        ...
        <Typography variant="h4" paragraph>
          Welcome to Phoenix Bathtubs, your bathtub refinishing
          experts. We offer high-quality, affordable solutions to revitalize your
          bathtub, sink, tiles, and more. Save time and money by refinishing
          your bathroom fixtures instead of replacing them.
        </Typography>
      </div>
